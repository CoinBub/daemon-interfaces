...
@DockerizedBitcoin
public class GetBlockIT implements StandardGetBlockIT<Bitcoin> {
    @Test
    @Override
    public void canGetSimpleBlock(final Bitcoin bitcoin) {
    ...
    @Test
    @Override
    public void canGetVerboseBlock(final Bitcoin bitcoin) {
        ...
        assertThat(first, hasAllIgnoringNull(
        ...
        assertThat(second, hasAllIgnoringNull(
