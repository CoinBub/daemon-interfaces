...
public class NormalizedBlackcoin implements Normalized<Blackcoin> {
    private final Blackcoin client;

    @Override
    public String getSymbol() {
        return Blackcoin.SYMBOL;
    }

    public NormalizedBlackcoin(final Blackcoin client) {
        this.client = client;
    }
