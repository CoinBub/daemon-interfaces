...
public class DaemonRunner<T> {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        new DaemonRunner(new NoopListener(), UUID.randomUUID().toString()).start(path, cmd, clientClass, normalizedClass);
    }

    public DaemonRunner() {
        this(new NoopListener());
    }
    public DaemonRunner(final Listener listener) {
        this(listener, UUID.randomUUID().toString());
    }
    public DaemonRunner(final Listener listener, final String id) {
